...
Gnome shell extension to open windows maximized in the last empty workspace, and adds couple of keybindings to help navigating through them by keeping track of which workspace each window originated from.
...
- multiple windows could be created from the same workspace, a new window and its decedents will take precedence. once it is and its decedents are closed the older stack is restored
